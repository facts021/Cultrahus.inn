...
const app = express();
// Port configuration: In Google AI Studio containers, port 3000 is strictly mandated.
// When deployed on external cloud hosts like Render (where process.env.RENDER is set),
// honor Render's assigned PORT or default to 10000.
...
// Persistence Path (supports Render persistent disk mount if DATA_DIR is configured)
